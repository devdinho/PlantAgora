...
class Profile(AbstractUser):
  ...
  profileType = models.CharField('Tipo de Perfil', max_length=1, choices=[(profileType.value, profileType.name) for profileType in ProfileType], default=ProfileType.GARDENER.value)
