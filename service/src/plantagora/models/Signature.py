...
class Signature(models.Model):
  ...
  garden = models.ForeignKey(Garden, on_delete=models.CASCADE, verbose_name='Garden', related_name='signatures', related_query_name='signature')
  grower = models.ForeignKey(Grower, on_delete=models.CASCADE, verbose_name='Grower', related_name='signatures', related_query_name='signature')
